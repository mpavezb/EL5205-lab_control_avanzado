...
typedef struct {
  ...
  real_T c_a_data_m[6724];
  real_T y_data[3321];
  real_T y_data_c[3321];
  real_T b_A_data[1681];
  real_T B_data[1681];
  real_T b_A_data_k[1681];
  real_T RLinv[1681];
  real_T TL[1681];
  real_T Q[1681];
  real_T D[1681];
  ...
  real_T TL_data[1681];
  real_T b_data[1681];
  real_T y_data_cx[1681];
  real_T b_b_data[1681];
  real_T y_data_b[1681];
  real_T C_data[1681];
  real_T b_A_data_p[1681];
  real_T b_A_data_c[1681];
  real_T B_data_f[1681];
  real_T b_A_data_g[1681];
  real_T RLinv_g[1681];
  real_T TL_m[1681];
  real_T Q_n[1681];
  real_T D_p[1681];
  real_T y_l[1681];
  real_T h_data_j[1681];
  real_T c_b_data_d[1681];
  real_T b_y_data_g[1681];
  real_T e_b_data_l[1681];
  real_T b_a_data_d[1681];
  real_T TL_data_d[1681];
  real_T b_data_l[1681];
  real_T y_data_o[1681];
  real_T b_b_data_b[1681];
  real_T y_data_n[1681];
  real_T C_data_b[1681];
  real_T b_A_data_l[1681];
  ...
  real_T mv_bias_n;                    /* '<S26>/mv_bias' */
  real_T Add_b[4];                     /* '<S29>/Add' */
  real_T rseq[120];                    /* '<S26>/ref_and_md' */
  real_T vseq[61];                     /* '<S26>/ref_and_md' */
  real_T v;                            /* '<S26>/ref_and_md' */
  real_T next_t;                       /* '<S26>/ref_and_md' */
  real_T u;                            /* '<S26>/optimizer' */
  real_T cost;                         /* '<S26>/optimizer' */
  real_T useq[60];                     /* '<S26>/optimizer' */
  real_T status;                       /* '<S26>/optimizer' */
  real_T rseq_d[120];                  /* '<S22>/ref_and_md' */
  real_T vseq_f[61];                   /* '<S22>/ref_and_md' */
  real_T v_g;                          /* '<S22>/ref_and_md' */
  real_T next_t_p;                     /* '<S22>/ref_and_md' */
  real_T u_l;                          /* '<S22>/optimizer' */
  real_T cost_l;                       /* '<S22>/optimizer' */
  real_T useq_n[60];                   /* '<S22>/optimizer' */
  real_T status_j;                     /* '<S22>/optimizer' */
  ...
  boolean_T iAout[161];                /* '<S26>/optimizer' */
  boolean_T iAout_d[241];              /* '<S22>/optimizer' */
} BlockIO_Planilla_3DOF_Crane;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T LastMVs_DSTATE;               /* '<S26>/Last MVs' */
  real_T LastMVs_DSTATE_g;             /* '<S22>/Last MVs' */
  ...
  real_T Memory_PreviousInput[4];      /* '<S29>/Memory' */
  real_T Memory1_PreviousInput_h;      /* '<S22>/Memory1' */
  real_T Memory_PreviousInput_a[4];    /* '<S25>/Memory' */
  ...
  int32_T sfEvent_l;                   /* '<S26>/optimizer' */
  int32_T sfEvent_b;                   /* '<S22>/ref_and_md' */
  int32_T sfEvent_i;                   /* '<S22>/optimizer' */
  uint32_T HILInitialize_POSortedChans[8];/* '<S7>/HIL Initialize' */
  uint8_T is_active_c4_mpclib;         /* '<S26>/ref_and_md' */
  uint8_T is_active_c3_cg3Dj4dh4X0KkDDeKm;/* '<S26>/optimizer' */
  uint8_T is_active_c4_mpclib_j;       /* '<S22>/ref_and_md' */
  uint8_T is_active_c3_F4T0CTRXYduoxKk8Jd;/* '<S22>/optimizer' */
  boolean_T Memory_PreviousInput_j[161];/* '<S26>/Memory' */
  boolean_T Memory_PreviousInput_c[241];/* '<S22>/Memory' */
  boolean_T isStable;                  /* '<S26>/ref_and_md' */
  boolean_T doneDoubleBufferReInit;    /* '<S26>/ref_and_md' */
  boolean_T isStable_j;                /* '<S26>/optimizer' */
  boolean_T doneDoubleBufferReInit_k;  /* '<S26>/optimizer' */
  boolean_T isStable_k;                /* '<S22>/ref_and_md' */
  boolean_T doneDoubleBufferReInit_o;  /* '<S22>/ref_and_md' */
  boolean_T isStable_o;                /* '<S22>/optimizer' */
...
struct Parameters_Planilla_3DOF_Crane_ {
  ...
  real_T SFunction_p17[2];             /* Expression: yoff
                                        * Referenced by: '<S22>/ref_and_md'
                                        */
  real_T SFunction_p1_g;               /* Expression: md_from_ws
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p2_d;               /* Expression: md_preview
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p3_c;               /* Expression: md_signal
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p4_n;               /* Expression: md_temp
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p5_m;               /* Expression: no_md
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p6_e;               /* Expression: no_ref
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p7_j;               /* Expression: nv
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p8_m;               /* Expression: ny
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p10_l;              /* Expression: p
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p11_c[120];         /* Expression: r_temp
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p12_m;              /* Expression: ref_from_ws
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p13_n;              /* Expression: ref_preview
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p14_d[2];           /* Expression: ref_signal
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p15_b[61];          /* Expression: v_temp
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p16_i;              /* Expression: voff
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  real_T SFunction_p17_e[2];           /* Expression: yoff
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<S7>/HIL Initialize'
                                        */
  real_T TowerSetpointConstant_Value;  /* Expression: 1
                                        * Referenced by: '<Root>/Tower Setpoint Constant '
                                        */
  ...
  real_T Memory_X0[4];                 /* Expression: lastx
                                        ...
                                        */
  real_T Gain3_Gain[8];                /* Expression: Cm
  ...
  real_T rhoeps_zero_Value;            /* Expression: 0
                                        ...
                                        */
  real_T md_zero_Value_g;              /* Expression: zeros(1,1)
                                        * Referenced by: '<S2>/md_zero'
                                        */
  real_T Memory1_X0_k;                 /* Expression: lastt
                                        * Referenced by: '<S22>/Memory1'
                                        */
  real_T umin_zero_Value_j;            /* Expression: zeros(1,1)
                                        * Referenced by: '<S2>/umin_zero'
                                        */
  real_T umax_zero_Value_n;            /* Expression: zeros(1,1)
                                        * Referenced by: '<S2>/umax_zero'
                                        */
  real_T ymin_zero_Value_b[2];         /* Expression: zeros(2,1)
                                        * Referenced by: '<S2>/ymin_zero'
                                        */
  real_T ymax_zero_Value_f[2];         /* Expression: zeros(2,1)
                                        * Referenced by: '<S2>/ymax_zero'
                                        */
  real_T switch_zero_Value_d;          /* Expression: 0
                                        * Referenced by: '<S2>/switch_zero'
                                        */
  real_T Memory_X0_a[4];               /* Expression: lastx
  ...
  real_T TmpRTBAtAdd1Inport3_X0;       /* Expression: 0
                                        * Referenced by: 'synthesized block'
                                        */
  real_T Gain5_Gain_h[8];              /* Expression: M
                                        * Referenced by: '<S25>/Gain5'
                                        */
  real_T LastMVs_X0_o;                 /* Expression: lastu
                                        * Referenced by: '<S22>/Last MVs'
                                        */
  real_T ywt_zero_Value_k[2];          /* Expression: zeros(2,1)
                                        * Referenced by: '<S2>/ywt_zero'
                                        */
  real_T duwt_zero_Value_c;            /* Expression: zeros(1,1)
                                        * Referenced by: '<S2>/duwt_zero'
                                        */
  real_T rhoeps_zero_Value_i;          /* Expression: 0
                                        * Referenced by: '<S2>/rhoeps_zero'
                                        */
  real_T mv_zero_Value;                /* Expression: zeros(1,1)
                                        * Referenced by: '<S2>/mv_zero'
                                        */
  ...
  real_T mv_bias_Bias;                 /* Expression: -uoff
                                        ...
                                        */
  real_T Gain_Gain_cz[16];             /* Expression: A
                                        * Referenced by: '<S25>/Gain'
                                        */
  real_T Gain1_Gain_n[4];              /* Expression: Bu
                                        * Referenced by: '<S25>/Gain1'
                                        */
  real_T Gain2_Gain[4];                /* Expression: Bv
                                        * Referenced by: '<S25>/Gain2'
                                        */
  real_T Gain3_Gain_h[8];              /* Expression: Cm
                                        * Referenced by: '<S25>/Gain3'
                                        */
  real_T Gain4_Gain_a[2];              /* Expression: Dvm
                                        * Referenced by: '<S25>/Gain4'
                                        */
  real_T ymoffset_Value_f[2];          /* Expression: myoff
                                        * Referenced by: '<S25>/ym offset'
                                        */
  real_T mv_zero_Value_n;              /* Expression: zeros(1,1)
                                        * Referenced by: '<S5>/mv_zero'
                                        */
  real_T mv_inport_Value_p;            /* Expression: mv_inport
                                        * Referenced by: '<S26>/mv_inport'
                                        */
  real_T u_select_Threshold_j;         /* Expression: 0.5
                                        * Referenced by: '<S26>/u_select'
                                        */
  real_T mv_bias_Bias_o;               /* Expression: -uoff
                                        * Referenced by: '<S26>/mv_bias'
                                        */
  real_T Gain_Gain_b[16];              /* Expression: A
                                        * Referenced by: '<S29>/Gain'
                                        */
  real_T Gain1_Gain_c[4];              /* Expression: Bu
                                        * Referenced by: '<S29>/Gain1'
                                        */
  real_T Gain2_Gain_j[4];              /* Expression: Bv
  ...
  boolean_T SFunction_p9;              /* Expression: openloopflag
                                        * Referenced by: '<S22>/ref_and_md'
                                        */
  boolean_T SFunction_p9_l;            /* Expression: openloopflag
                                        * Referenced by: '<S26>/ref_and_md'
                                        */
  ...
  boolean_T HILWrite_Active;           /* Computed Parameter: HILWrite_Active
                                        * Referenced by: '<S7>/HIL Write'
                                        */
  boolean_T Memory_X0_d[161];          /* Expression: iA
                                        * Referenced by: '<S26>/Memory'
                                        */
  boolean_T Memory_X0_g[241];          /* Expression: iA
 ...
 * '<S2>'   : 'Planilla_3DOF_Crane/Jib MPC Controller'
 * '<S3>'   : 'Planilla_3DOF_Crane/Powered by QUARC'
 * '<S4>'   : 'Planilla_3DOF_Crane/Tower (A)'
 * '<S5>'   : 'Planilla_3DOF_Crane/Tower MPC Controller'
 ...
 * '<S22>'  : 'Planilla_3DOF_Crane/Jib MPC Controller/MPC'
 * '<S23>'  : 'Planilla_3DOF_Crane/Jib MPC Controller/MPC/optimizer'
 * '<S24>'  : 'Planilla_3DOF_Crane/Jib MPC Controller/MPC/ref_and_md'
 * '<S25>'  : 'Planilla_3DOF_Crane/Jib MPC Controller/MPC/state estimator'
 * '<S26>'  : 'Planilla_3DOF_Crane/Tower MPC Controller/MPC'
 * '<S27>'  : 'Planilla_3DOF_Crane/Tower MPC Controller/MPC/optimizer'
 * '<S28>'  : 'Planilla_3DOF_Crane/Tower MPC Controller/MPC/ref_and_md'
 * '<S29>'  : 'Planilla_3DOF_Crane/Tower MPC Controller/MPC/state estimator'
 */
