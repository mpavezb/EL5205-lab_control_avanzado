...
%   Detailed explanation goes here
    ...
    subplot(224);plot(ELD(:,1), ELD(:,N) - ELD2(:,N),'-b','displayname','$\dot{\theta}$'); xlabel('Tiempo [s]'); ylabel('Vel. Angular [rad/s]');hlegend1 = legend(gca, 'show', 'location', 'best'); set(hlegend1,'Interpreter','latex');
    suptitle(title_plot);
end
